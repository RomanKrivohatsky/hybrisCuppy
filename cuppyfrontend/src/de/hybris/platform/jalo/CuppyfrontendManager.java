...
import de.hybris.platform.constants.CuppyfrontendConstants;



/**
 * This is the extension manager of the Cuppyfrontend extension.
 */
public class CuppyfrontendManager extends GeneratedCuppyfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CuppyfrontendManager.class.getName());
	 ...
	 */
	public static CuppyfrontendManager getInstance()
	{
		return (CuppyfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CuppyfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CuppyfrontendManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CuppyfrontendManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CuppyfrontendManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CuppyfrontendManager called, current tenant: " + getTenant().getTenantID());
		}
	}
